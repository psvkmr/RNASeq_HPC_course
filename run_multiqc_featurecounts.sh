...
#SBATCH --verbose
#SBATCH --output=/scratch/users/%u/teaching/logs/run_multiqc_featurecounts.out
...
multiqc ${base_dir}/outputs/gene_expression/ -n ${user_dir}/teaching/outputs/multiqc/multiqc_featurecounts.html
